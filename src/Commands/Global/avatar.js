const { Discord, MessageEmbed, MessageSelectMenu, MessageButton , MessageActionRow  } = require("discord.js");
...
module.exports = {
    ...
    async function bannerXd(user, client) {
        ...
        if(!response.data.banner) return `https://media.discordapp.net/attachments/823550703058288682/957313971214499960/IMG-20220312-WA0001.jpg`
